           ...
           <div class="row">
               <div class="col-md-4">
                   <form method="POST" action="{{route('doc.search.store')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input name="code_archive" type="text" class="form-control @error('code_archive')  is-invalid @enderror"
                            placeholder="Code archive" value="{{ old('code_archive') }}">
                        @error('code_archive')
                            <span class="invalid-feedback" role="alert">
                            </span>
                        @enderror
               ...
               <div class="col-md-8">
                ...
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <td><a href="{{route('doc.patients.show',$item->id)}}">{{$item->f_name}}&nbsp;{{$item->l_name}}</a></td>
                        <td>{{$item->birthday}}</td>
                        <td>{{$item->phone}}</td>
